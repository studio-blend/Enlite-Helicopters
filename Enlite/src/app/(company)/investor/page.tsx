        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <ScrollReveal>
             ...
             <p className="text-xl text-text-hero/80 max-w-2xl leading-relaxed">
               Partner with Enlite Helicopters to build the future of autonomous aerial logistics.
             </p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollReveal direction="left">
              <h2 className="text-4xl lg:text-5xl font-bold tracking-tight text-text-primary leading-tight">
                Partner with<br />Enlite Helicopters
              </h2>
            </ScrollReveal>
            ...
            <div className="bg-bg-card border border-border-default rounded-2xl p-8 lg:p-12 shadow-xl">
              ...
              <form className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select required className="w-full bg-bg-primary border border-border-default rounded-lg px-4 py-3 text-text-primary focus:outline-none focus:border-brand-red focus:ring-1 focus:ring-brand-red transition-colors appearance-none" defaultValue="">
