  ...
  return (
    <div className="flex flex-col min-h-screen bg-bg-primary text-text-primary">
      ...
      <AboutVideoSection 
        ...
        videoSubtitle={pageData?.videoSubtitle}
        videoDescription={pageData?.videoDescription}
        videoUrl={pageData?.videoUrl}
        videoThumbnail={pageData?.videoThumbnail}
        videoPlayMode={pageData?.videoPlayMode}
      />
