...
import { ArrowRight, Package, Mountain, ShieldPlus, Crosshair, Target } from "lucide-react";
...
// Static fallback cards shown when Sanity has no documents yet
const staticMarkets = [
  {
    id: "intercity",
    ...
    description:
      "Rapid transportation of high-value goods between urban centers, bypassing ground congestion with a 500 km range.",
  ...
  },
  {
    ...
    category: "Civilian Logistics",
    description:
      "Reliable supply chain connections for mountainous, island, and rural areas using autonomous heavy-lift helicopters.",
  ...
  },
  {
    ...
    description:
      "Swift, autonomous delivery of critical medical supplies, organs, and disaster relief aid within the golden hour.",
  ...
  },
  {
    ...
    description:
      "Tactical autonomous logistics for forward operating bases. Low-altitude, stealthy supply delivery with heavy-lift capabilities.",
...
export default async function MarketsPage() {
  ...
  const usingSanity = markets.length > 0;
